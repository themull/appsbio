...
<div class="form_input">
	<div class="header_input">
		<h1 align="center">DATA PELATIHAN</h1>
	</div>
	<div class="box-data">
		<form action="#" >
        ...
        <th><div align="center"><strong>id Pelatihan</strong></div></th>
        <th><div align="center"><strong>Tanggal Pelatihan</strong></div></th>
        <th><div align="center"><strong>Waktu Pelatihan</strong></div></th>
        <th><div align="center"><strong>Kegiatan</strong></div></th>
        <th><div align="center"><strong>Deskripsi</strong></div></th>
        <th><div align="center"><strong>Harga</strong></div></td>
        ...
        <th colspan="2"><div align="center"><strong>Aksi</strong></div></th>
            ...
            $no=0+$posisi;
              $tampil="SELECT * FROM pelatihan order by pelatihan_tanggal desc limit $posisi, $batas";
            ...
            $tgl=date('d F Y', strtotime($dataTampil['pelatihan_tanggal']));
            $waktu=date('H:i', strtotime($dataTampil['pelatihan_waktu']));
            ...
            <td align="center" data-label="id pelatihan"><?php echo $dataTampil['id_pelatihan']; ?></td>
            <td align="center" data-label="tanggal"><?php echo $tgl; ?></td>
            <td align="center" data-label="waktu"><?php echo $waktu; ?></td>
            <td align="center" data-label="kegiatan"><?php echo $dataTampil['pelatihan_kegiatan']; ?></td>
            ...
            <td align="center" data-label="id_user"><?php echo $dataTampil['id_user']; ?></td>
            <td align="center"data-label="status"><?php echo $o; ?></td>
            <td>
            <div align="center">
            <a href="edit_pelatihan.php?id_pelatihan=<?php echo $dataTampil['id_pelatihan']; ?> "class="Edit"><i class="fas fa-edit"></i>Edit</a>
            </div>
            </td>
            <td>
            <div align="center">
            <a href="hapus_pelatihan.php?id_pelatihan=<?php echo $dataTampil['id_pelatihan'] ; ?>" class="delete" onclick="javascript: return confirm('Anda yakin hapus ?')"><i class="fas fa-trash-alt"></i>hapus</a>
            </div>
            </td>
            </tr>
            <?php } ?>
