...
<div class="form_input">
	...
	<div class="box-data">
		<form action="tambah_driver.php" method="POST" enctype="multipart/form-data">
		<input type="submit" class="btn-tambah" value="Tambah Driver"  />
		<table class="tabel-data-banyak" >
        <tr bgcolor="#90EE90">
        <th><div align="center"><strong>No</strong></div></th>
        <th><div align="center"><strong>Nama Driver</strong></div></th>
        ...
        <th colspan="2"><div align="center"><strong>Aksi</strong></div></th>
            ...
            $no=0+$posisi;
              $tampil="SELECT * FROM driver limit $posisi, $batas";
            ...
            <td align="center" data-label="nama"><?php echo $dataTampil['nama_driver']; ?></td>
            <td align="center" data-label="no HP"><?php echo $dataTampil['no_hp']; ?></td>
            <td>
            <div align="center">
            <a href="edit_driver.php?id_driver=<?php echo $dataTampil['id_driver']; ?> "class="Edit"><i class="fas fa-edit"></i>Edit</a>
            </div>
            </td>
            <td>
            <div align="center">
            <a href="hapus_driver.php?id_driver=<?php echo $dataTampil['id_driver'] ; ?>" class="delete" onclick="javascript: return confirm('Anda yakin hapus ?')"><i class="fas fa-trash-alt"></i>hapus</a>
            </div>
            </td>
            </tr>
            <?php } ?>
            ...
            <?php
            //hitung jumlah data
            $jml_data = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM driver"));
            //Jumlah halaman
